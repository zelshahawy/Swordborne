...
pub(crate) struct LevelArtHandles {
    ...
    pub fountain_mid_red_frames: [Handle<Image>; FOUNTAIN_FRAMES],
    pub fountain_red_frames: [Handle<Image>; FOUNTAIN_FRAMES],
    pub wall_goo: Handle<Image>,
    pub wall_goo_base: Handle<Image>,
...
pub(crate) fn load_level_art(mut commands: Commands, asset_server: Res<AssetServer>) {
    commands.insert_resource(LevelArtHandles {
        ...
        fountain_mid_red_frames: [
            asset_server.load("dungeon/frames/wall_fountain_mid_red_anim_f0.png"),
            asset_server.load("dungeon/frames/wall_fountain_mid_red_anim_f1.png"),
            asset_server.load("dungeon/frames/wall_fountain_mid_red_anim_f2.png"),
        ],
        fountain_red_frames: [
            asset_server.load("dungeon/frames/wall_fountain_basin_red_anim_f0.png"),
            asset_server.load("dungeon/frames/wall_fountain_basin_red_anim_f1.png"),
            asset_server.load("dungeon/frames/wall_fountain_basin_red_anim_f2.png"),
        ],
        wall_goo: asset_server.load("dungeon/frames/wall_goo.png"),
        wall_goo_base: asset_server.load("dungeon/frames/wall_goo_base.png"),
        ...
        heart_full: asset_server.load("dungeon/frames/ui_heart_full.png"),
        heart_empty: asset_server.load("dungeon/frames/ui_heart_empty.png"),
        chest_closed: asset_server.load("dungeon/frames/chest_full_open_anim_f0.png"),
        chest_open: asset_server.load("dungeon/frames/chest_full_open_anim_f2.png"),
